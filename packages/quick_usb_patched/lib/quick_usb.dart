...
class QuickUsb {
  ...
  /// Clear the halt/stall condition on [endpoint]. Best-effort — returns
  /// false when the platform doesn't support it or the transfer fails.
  static Future<bool> clearHalt(UsbEndpoint endpoint) =>
      _platform.clearHalt(endpoint);
}
